  ...
  <div className="bg-white pb-6 sm:pb-8 lg:pb-12">
    <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
      <header className="mb-4 flex items-center justify-between py-4 md:py-8">
        ...
        <a
          href="#"
          className="hidden rounded-lg bg-blue-500 px-8 py-3 text-center text-sm font-semibold  outline-none ring-indigo-300 transition duration-100 hover:bg-blue-300 focus-visible:ring  md:text-base lg:inline-block"
        >
          Login
        </a>
        <button
          type="button"
          className="inline-flex items-center gap-2 rounded-lg bg-blue-500 px-2.5 py-2 text-sm font-semibold  ring-indigo-300 hover:bg-blue-300 focus-visible:ring  md:text-base lg:hidden"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-6 w-6"
