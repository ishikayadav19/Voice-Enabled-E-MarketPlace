...
<>
  ...
  <div className="bg-white pb-6 sm:pb-8 lg:pb-12">
    <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
      ...
      <section className=" relative flex flex-1 shrink-0 items-center justify-center overflow-hidden rounded-lg bg-gray-100 py-16 shadow-lg h-screen md:py-20 xl:py-48">
        {/* image - start */}
        <img
  src="/banner.jpeg"
  alt="Voice Shopping"
